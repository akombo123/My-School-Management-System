...
<div class="app-content-header">
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-6"><h3 class="mb-0">Exam Results</h3></div>
        <div class="col-sm-6">
        ...
        @foreach ($getRecord as $value)
          <div class="card mb-4">
            <div class="card-header"><h3 class="card-title">{{ $value['exam_name'] }}</h3>
                <a style="float: right" target="_blank" href="{{ url('student/exam-result/print?exam_id='.$value['exam_id'].'&student_id='.Auth::user()->id ) }}" class="btn btn-primary btn-sm">Print</a>
            </div>
            <div class="card-body">
                ...
                <tbody>
                 ...
                 <tr>
                    ...
                    <td>
                        ...
                        @endphp
                        <b><b>Percentage:</b>{{ number_format($percentage,2) }}%</b>
                    </td>
                    <td>
                        @php
                            $percentage = ($total_marks/ $total_full_marks)*100;
