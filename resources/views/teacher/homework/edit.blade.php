              ...
              <div class="card-body">
                <div class="mb-3">
                    ...
                    <select name="class_id" id="getClass" class="form-control">
                      ...
                      @foreach ($getClass as $user)
                        <option {{ ($getRecord->class_id == $user->class_id) ? 'selected' : '' }} value="{{ $user->class_id }}">{{ $user->class_name }}</option>
                      @endforeach
                    </select>
                  </div>
                ...
                <div class="mb-3">
                    ...
                    <input
                      name="homework_date"
                      type="date"
                      value="{{ old('homework_date',$getRecord->homework_date) }}"
                      class="form-control"
                    />
                  </div>
                  ...
                  <div class="mb-3">
                    ...
                    <input
                      ...
                      type="date"
                      value="{{ old('submission_date',$getRecord->submission_date) }}"
                      class="form-control"
                    />
                  </div>
                  ...
                  <div class="mb-3">
                    ...
                    @if(!empty($getRecord->getDocument()))
                            <a style="margin-top: 5px" class="btn btn-primary btn-sm" href="{{ asset('uploads/homework/'.$getRecord->document_file) }}" download="" target="_blank">Download</a>
                        @else
                            N/A
                        @endif
                  </div>
