    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
                  ...
                  <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <a class="btn btn-warning ms-2" href="{{ url('teacher/attendance/report') }}" style="margin-top: 24px">Reset
                            </a>
                        </div>
                    </div>
                  </div>
          ...
          <div class="card mb-4">
            <div class="card-header"><h3 class="card-title">Student Attendance Report</h3></div>
            <div class="card-body">
