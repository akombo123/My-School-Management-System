...
<div class="app-content-header">
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-6"><h3 class="mb-0">My Attendance ({{ $getStudent->name }} {{ $getStudent->l_name }})</h3></div>
        <div class="col-sm-6">
      ...
      <div class="row">
        <div class="col-md-12">
            ...
            <div class="card card-primary card-outline mb-4">
                <div class="card-header"><div class="card-title">Search My Attendance</div></div>
                  ...
                  <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <a class="btn btn-warning ms-2" href="{{ url('parent/my-student/attendance/'.$getStudent->id) }}" style="margin-top: 24px">Reset
                            </a>
                        </div>
                    </div>
                  </div>
