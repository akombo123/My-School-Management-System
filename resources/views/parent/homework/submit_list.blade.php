...
<div class="app-content-header">
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-6"><h3 class="mb-0">({{ $getUser->name }} {{ $getUser->l_name }}) Submitted Homework List</h3></div>
        <div class="col-sm-6">
                 ...
                 <tr class="align-middle">
                    ...
                    <td>
                        @if(!empty($value->getHomework->getDocument()))
                            <button class="btn btn-primary btn-sm" href="{{ asset('uploads/homework/'.$value->getHomework->document_file) }}" download="" target="_blank">Download</button>
                        @else
                            N/A
                        @endif
                    </td>
